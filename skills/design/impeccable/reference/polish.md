...
```bash
sh "$HOME/AppData/Local/hermes/skills/design/impeccable/scripts/impeccable" critique-storage latest "<resolved target>" --json
```
...
```bash
sh "$HOME/AppData/Local/hermes/skills/design/impeccable/scripts/impeccable" critique-storage close "<resolved target>" "<snapshot_file returned by latest>"
```
