...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/storage.ts src/infra/storage/storage.ts
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/FileField.tsx src/components/form/FileField.tsx
# Optional: a gallery page showcasing avatar + multi-file upload
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/file-upload.tsx src/routes/_app/<name>.tsx
```
