...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/GlobalSearch.tsx src/components/GlobalSearch.tsx
# Optional: an always-open demo over mock resources
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/global-search.tsx src/routes/_app/search.tsx
```
