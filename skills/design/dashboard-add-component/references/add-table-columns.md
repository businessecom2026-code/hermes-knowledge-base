...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/ColumnControls.tsx src/infra/table/ColumnControls.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/table-columns.tsx src/routes/_app/<name>.tsx
```
