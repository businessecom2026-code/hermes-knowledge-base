...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/ComboboxField.tsx src/components/form/ComboboxField.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/form-combobox.tsx src/routes/_app/<name>.tsx
```
