...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/orders.tsx src/routes/_app/<name>.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/orders.\$id.tsx src/routes/_app/<name>.\$id.tsx
```
