...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/TagList.tsx src/components/data/TagList.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/MetadataList.tsx src/components/data/MetadataList.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/ProgressTile.tsx src/components/data/ProgressTile.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/UserCell.tsx src/components/data/UserCell.tsx
# Optional: a gallery page showcasing all four
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/data-display.tsx src/routes/_app/<name>.tsx
```
