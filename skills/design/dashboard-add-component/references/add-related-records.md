...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/RelatedList.tsx src/components/data/RelatedList.tsx
# Optional: a gallery page showcasing a parent + two related lists
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/related-records.tsx src/routes/_app/<name>.tsx
```
