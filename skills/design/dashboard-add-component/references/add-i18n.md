...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/i18n.tsx src/lib/i18n.tsx
# Optional: a panel showing a live locale switcher
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/localization.tsx src/routes/_app/settings/language.tsx
```
