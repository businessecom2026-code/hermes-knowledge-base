...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/PlanCard.tsx src/components/billing/PlanCard.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/UsageMeter.tsx src/components/billing/UsageMeter.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/billing.tsx src/routes/_app/billing.tsx
```
