...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/csv.ts src/infra/data/csv.ts
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/export-import.tsx src/routes/_app/<name>.tsx
```
