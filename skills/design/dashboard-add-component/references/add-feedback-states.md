...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/StateView.tsx src/components/feedback/StateView.tsx
# Optional: a gallery page showcasing StateView + Sheet + Alert + toast
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/feedback.tsx src/routes/_app/<name>.tsx
```
