...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/rbac.ts src/lib/rbac.ts
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/RoleGate.tsx src/components/RoleGate.tsx
```
