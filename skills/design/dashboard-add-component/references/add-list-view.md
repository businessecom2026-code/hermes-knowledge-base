...
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/list-lite.tsx src/routes/_app/<name>.tsx
# OR collapsible sections that lazy-load items on first expand
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/list-lazy.tsx src/routes/_app/<name>.tsx
```
