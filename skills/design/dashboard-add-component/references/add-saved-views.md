...
```bash
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/SavedViews.tsx src/infra/table/SavedViews.tsx
cp $HOME/AppData/Local/hermes/skills/design/dashboard-add-component/templates/saved-views.tsx src/routes/_app/<name>.tsx
```
