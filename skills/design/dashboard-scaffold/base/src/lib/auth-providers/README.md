...
the [`add-backend`](../../../$HOME/AppData/Local/hermes/skills/design/dashboard-add-backend) skill. They are **dormant** —
...
See each preset's `$HOME/AppData/Local/hermes/skills/design/dashboard-add-backend/references/<preset>.md` and
