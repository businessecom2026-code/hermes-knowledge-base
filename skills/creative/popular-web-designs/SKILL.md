...
description: 74 real design systems (Stripe, Linear, Vercel, Apple, Nike, Tesla) as HTML/CSS.
version: 1.0.0
...
| Template | Site | Style |
|---|---|---|
| `bmw-m.md` | BMW M | Motorsport contrast, tri-color accent, aggressive geometry |
| `bugatti.md` | Bugatti | Hyper-luxury minimalism, deep blue, generous white space |
| `ferrari.md` | Ferrari | Rosso Corsa accent, editorial hero, high-gloss product shots |
| `lamborghini.md` | Lamborghini | Angular brutalist geometry, stark black, hexagonal motifs |
| `renault.md` | Renault | Bright yellow accent, approachable European modernism |
| `tesla.md` | Tesla | Full-bleed imagery, near-invisible chrome, monochrome UI |

### Varejo, Consumo & Esporte

| Template | Site | Style |
|---|---|---|
| `nike.md` | Nike | Bold black display type, full-bleed motion imagery, red accent |
| `shopify.md` | Shopify | Commerce green, friendly rounded forms, conversion-first |
| `starbucks.md` | Starbucks | Deep green, warm photography, rounded editorial cards |
| `mastercard.md` | Mastercard | Overlapping circles, orange-red gradient, institutional trust |
| `binance.md` | Binance | Crypto yellow on black, data-dense trading surfaces |

### Mídia & Editorial

| Template | Site | Style |
|---|---|---|
| `theverge.md` | The Verge | High-chroma editorial, oversized headlines, playful chrome |
| `wired.md` | Wired | Condensed display type, stark black/white, hard grid |
| `meta.md` | Meta | Infinite-blue gradient, soft geometric, corporate-friendly |
| `slack.md` | Slack | Aubergine plum, playful multi-color, conversational UI |

### Hardware & Retro

| Template | Site | Style |
|---|---|---|
| `playstation.md` | PlayStation | Gaming blue, glassy depth, iconographic shapes |
| `nintendo-2001.md` | Nintendo (2001) | Retro web era, chunky borders, saturated primaries |
| `dell-1996.md` | Dell (1996) | Table-layout nostalgia, system fonts, 90s corporate web |
| `hp.md` | HP | Enterprise blue, clean product grid, restrained chrome |
| `vodafone.md` | Vodafone | Telecom red, bold circular speech mark, high-contrast CTA |
...
- **Automotivo / performance:** Ferrari, Lamborghini, BMW M, Bugatti, Tesla
- **Editorial / revista:** The Verge, Wired, Notion
- **Varejo / e-commerce:** Shopify, Nike, Starbucks
- **Retro / nostalgia web:** Nintendo (2001), Dell (1996)